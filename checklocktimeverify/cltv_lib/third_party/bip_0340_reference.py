"""
Vendored BIP-0340 Schnorr Signature Reference Implementation

Source: https://github.com/bitcoin/bips/blob/master/bip-0340/reference.py
Authors: Pieter Wuille, Jonas Nick, Tim Ruffing, and others (Bitcoin Core contributors)

License: BSD-2-Clause (Bitcoin BIPs repository license)
See: https://github.com/bitcoin/bips/blob/master/COPYING

This file is vendored for test-only purposes to avoid introducing external
dependencies. The original code is from the Bitcoin BIPs repository and is
used under the BSD-2-Clause license.

If you use this outside of tests, consider depending on an upstream library
or the original BIP-0340 reference implementation instead.
"""

# Reference implementation from BIP-0340 (Schnorr Signatures for secp256k1)
